      ...
      <header className="bg-blue-600 border-b border-blue-700 px-6 py-4">
        <div className="max-w-5xl mx-auto flex flex-col sm:flex-row sm:items-center gap-3">
          <div className="flex items-center gap-3">
            <Link href="/" className="p-2 bg-white/20 rounded-lg hover:bg-white/30 transition-colors shrink-0">
          ...
          <div className="flex items-center flex-wrap gap-2 sm:ml-auto">
            <Link
              href="/articles"
              className="shrink-0 text-xs text-blue-100 hover:text-white border border-blue-400 hover:border-white px-3 py-1.5 rounded-lg transition-colors whitespace-nowrap"
            >
              コラム記事
            </Link>
            <Link
            ...
            <a
              ...
              className="shrink-0 flex items-center gap-1.5 bg-green-500 hover:bg-green-400 text-white text-xs font-bold px-3 py-1.5 rounded-lg transition-colors whitespace-nowrap"
            >
